 ...
 */
public class EvaluarL2 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarl2_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 3, 13, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarL2.this, EvaluarL3.class));
                finish();
                break;
        }
    }
