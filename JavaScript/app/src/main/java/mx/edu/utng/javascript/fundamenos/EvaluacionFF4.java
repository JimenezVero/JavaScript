 ...
 */
public class EvaluacionFF4 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarf4_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 2, 10, resultadoCheck);
                ...
                if (registros == 0) {
                    ...
                    int aciertos = dao.obtenerResultados1(db, estado);
            ...
            case R.id.btn_continuar:
                ...
                if (aciertos >= 4) {
                    ...
                    startActivity(new Intent(EvaluacionFF4.this, ContenidoFF.class));
                    finish();
                }
