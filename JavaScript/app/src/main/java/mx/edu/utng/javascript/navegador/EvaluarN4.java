 ...
 */
public class EvaluarN4 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarn4_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1,8,40,resultadoCheck);
                ...
                if(registros==0){
                    ...
                    int aciertos = dao.obtenerResultados7(db, estado);
            ...
            case R.id.btn_continuar:
                ...
                Log.d("Aciertos ", " " + aciertos);
                if(aciertos>=4){
                    PieGraph7 pie = new PieGraph7();
                    Intent lineIntent = pie.getIntent(this);
                    startActivity(lineIntent);
                    finish();
                }else {
                    startActivity(new Intent(EvaluarN4.this, ContenidoN.class));
                    finish();
                }
