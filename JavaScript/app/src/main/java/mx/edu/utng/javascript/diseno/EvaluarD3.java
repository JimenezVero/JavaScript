 ...
 */
public class EvaluarD3 extends Activity implements View.OnClickListener{
//crae variables
...
//instanciar
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluard3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 7, 34, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarD3.this, EvalauarD4.class));
                finish();
                break;
        }
    }
