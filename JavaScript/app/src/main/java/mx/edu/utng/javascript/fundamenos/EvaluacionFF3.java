 ...
 */
public class EvaluacionFF3 extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarf3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 2, 9, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluacionFF3.this, EvaluacionFF4.class));
                finish();
                break;
        }
    }
