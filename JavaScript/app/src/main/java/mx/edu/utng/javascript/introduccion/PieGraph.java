...
public class PieGraph {
	...
	public Intent getIntent(Context context) {
		...
		CategorySeries series = new CategorySeries("Aaprovechamiento");
		int k = 0;
		for (int value : values) {
			series.add("Contenido " + ++k, value);
		}

		int[] colors = new int[] { Color.CYAN, Color.DKGRAY, Color.DKGRAY, Color.DKGRAY, Color.DKGRAY, Color.DKGRAY, Color.DKGRAY, Color.DKGRAY};
