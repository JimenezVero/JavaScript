 ...
 */
public class EvaluarO2 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluaro2layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 5, 23, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarO2.this, EvaluarO3.class));
                finish();
                break;
        }
    }
