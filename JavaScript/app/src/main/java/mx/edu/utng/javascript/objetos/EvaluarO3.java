 ...
 */
public class EvaluarO3 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.codigoi1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 5, 24, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarO3.this, EvaluarO4.class));
                finish();
                break;
        }
    }
