 ...
 */
public class EvaluacionFF1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarf1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 2, 7, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluacionFF1.this, EvaluacionFF2.class));
                finish();
                break;
        }
    }
