...
public class Juego extends Activity {
    ...
    private void initcomponents() {
        ...
        botonA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Palabra.equals("JavaScript")) {
                    MediaPlayer mp = MediaPlayer.create(Juego.this, R.raw.s1);
                    mp.start();
                    Toast.makeText(getApplicationContext(), "Correcto", Toast.LENGTH_SHORT).show();

                } else {
                    MediaPlayer mp = MediaPlayer.create(Juego.this, R.raw.s2);
                    mp.start();
    ...
    public void presionBotonSiguiente(View v) {
        ...
        if (Palabra.equals("JavaScript")){
            startActivity(new Intent(Juego.this, Juego1.class));
            finish();
        }else {
            startActivity(new Intent(Juego.this, Juego.class));
            finish();
        }
