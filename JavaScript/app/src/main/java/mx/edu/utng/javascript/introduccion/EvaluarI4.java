 ...
 */
public class EvaluarI4 extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluari4_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1,1,5, resultadoCheck);
            ...
            case R.id.btn_continuar:
                ...
                if(aciertos>=4){
                    ...
                    startActivity(new Intent(EvaluarI4.this, ContenidoI.class));
                    finish();
                }
