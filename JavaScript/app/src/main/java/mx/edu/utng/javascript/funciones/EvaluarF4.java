 ...
 */
public class EvaluarF4 extends Activity implements View.OnClickListener {
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluacionff4_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 4, 20, resultadoCheck);
            ...
            case R.id.btn_continuar:
                ...
                if (aciertos >= 4) {
                    ...
                    startActivity(new Intent(EvaluarF4.this, ContenidoF.class));
                    finish();
                }
