 ...
 */
public class EvaluarP2 extends Activity implements View.OnClickListener {
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarp2_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 6, 28, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarP2.this, EvaluarP3.class));
                finish();
                break;
        }
    }
