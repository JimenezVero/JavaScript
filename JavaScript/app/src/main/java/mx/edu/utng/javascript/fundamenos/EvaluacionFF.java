 ...
 */
public class EvaluacionFF extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarf_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 2, 6, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluacionFF.this, EvaluacionFF1.class));
                finish();
                break;
        }
    }
