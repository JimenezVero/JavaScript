 ...
 */
public class EvaluarI extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluari_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 1, 1, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarI.this, EvaluarI1.class));
                finish();
                break;
        }
    }
