 ...
 */
public class EvaluarP extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarp_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 6, 26, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarP.this, EvaluarP1.class));
                finish();
                break;
        }
    }
