...
/**
 * Created by Iruzz on 18/04/2016.
 */
public class EvaluarP4 extends Activity  implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarp4_layou);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 6, 30, resultadoCheck);
                ...
                if (registros == 0) {
                    ...
                    if (aciertos >= 4) {
                        Toast toast = Toast.makeText(this, "Evaluacion Aprobado", Toast.LENGTH_SHORT);
                        toast.show();
                    } else {
                        Toast toast = Toast.makeText(this, "Evaluacion No Aprobado", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                } else {
            ...
            case R.id.btn_continuar:
                ...
                if (aciertos >= 4) {
                    ...
                    startActivity(new Intent(EvaluarP4.this, ContenidoP.class));
                    finish();
                }
