 ...
 */
public class EvaluarL1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarl1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 3, 12, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarL1.this, EvaluarL2.class));
                finish();
                break;
        }
    }
