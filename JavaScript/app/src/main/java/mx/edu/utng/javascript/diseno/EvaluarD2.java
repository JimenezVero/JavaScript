 ...
 */
public class EvaluarD2 extends Activity implements View.OnClickListener{
...
//Instanciar
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluard2_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 7, 33, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarD2.this, EvaluarD3.class));
                finish();
                break;
        }
    }
