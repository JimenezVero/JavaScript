...
public class Juego2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego2_layout);
        initcomponents();
    }
        ...
        botonA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Palabra.equals("Java")) {
                    MediaPlayer mp = MediaPlayer.create(Juego2.this, R.raw.s1);
                    mp.start();
                    Toast.makeText(getApplicationContext(), "Correcto", Toast.LENGTH_SHORT).show();

                } else {
                    MediaPlayer mp = MediaPlayer.create(Juego2.this, R.raw.s2);
                    mp.start();
    ...
    public void presionBotonSiguiente(View v) {
        ...
        if (Palabra.equals("Java")){
            startActivity(new Intent(Juego2.this, Juego3.class));
            finish();
        }else {
            startActivity(new Intent(Juego2.this, Juego2.class));
            finish();
        }
