 ...
 */
public class EvaluarN extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarn_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 8, 36, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarN.this, EvaluarN1.class));
                finish();
                break;
        }
    }
