 ...
 */
public class EvaluarN1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarn1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 8, 37, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarN1.this, EvaluarN2.class));
                finish();
                break;
        }
    }
