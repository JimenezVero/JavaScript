 ...
 */
public class EvaluarF3 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluacionff3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 4, 19, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarF3.this, EvaluarF4.class));
                finish();
                break;
        }
    }
