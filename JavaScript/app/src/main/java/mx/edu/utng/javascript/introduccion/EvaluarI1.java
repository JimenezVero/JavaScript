...
public class EvaluarI1 extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluari1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 1, 2, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarI1.this, EvaluarI2.class));
                finish();
                break;
        }
    }
