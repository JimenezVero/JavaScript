 ...
 */
public class EvaluarI3 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluari3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 1, 4, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarI3.this, EvaluarI4.class));
                finish();
                break;
        }
    }
