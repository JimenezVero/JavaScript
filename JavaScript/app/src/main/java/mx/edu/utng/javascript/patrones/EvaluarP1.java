 ...
 */
public class EvaluarP1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarp1_layout);
    ...
    //Iniciar componentes//Instanciar
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 6, 27, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarP1.this, EvaluarP2.class));
                finish();
                break;
        }
    }
