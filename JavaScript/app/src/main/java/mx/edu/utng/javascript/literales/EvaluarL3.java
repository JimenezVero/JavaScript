 ...
 */
public class EvaluarL3 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarl3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 3, 14, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarL3.this, EvaluarL4.class));
                finish();
                break;
        }
    }
