 ...
 */
public class EvaluarF extends Activity implements View.OnClickListener{
    //crear variables
    ...
    private Chronometer cronometro;    //Instanciar
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.evaluarff_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 4, 16, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarF.this, EvaluarF1.class));
                finish();
                break;
        }
    }
