...
public class Juego3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego3_layout);
        initcomponents();
    }
    ...
    private void initcomponents() {
        ...
        botonA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Palabra.equals("DOM y Patrones de Navegador")) {
                    MediaPlayer mp = MediaPlayer.create(Juego3.this, R.raw.s1);
                    mp.start();
                    Toast.makeText(getApplicationContext(), "Correcto", Toast.LENGTH_SHORT).show();

                } else {
                    MediaPlayer mp = MediaPlayer.create(Juego3.this, R.raw.s2);
                    mp.start();
    ...
    public void presionBotonSiguiente(View v) {
        ...
        if (Palabra.equals("DOM y Patrones de Navegador")){
            startActivity(new Intent(Juego3.this, Juego4.class));
            finish();
        }else {
            startActivity(new Intent(Juego3.this, Juego3.class));
            finish();
        }
