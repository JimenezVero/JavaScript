 ...
 */
public class EvaluarF1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluacionff1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 4, 17, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarF1.this, EvaluarF2.class));
                finish();
                break;
        }
    }
