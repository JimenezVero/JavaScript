 ...
 */
public class EvaluarD extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluard_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 7, 31, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarD.this, EvaluarD1.class));
                finish();
                break;
        }
    }
