 ...
 */
public class EvaluarP3 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarp3_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 6, 29, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarP3.this, EvaluarP4.class));
                finish();
                break;
        }
    }
