 ...
 */
public class
        EvaluarO extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluaro_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 5, 21, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarO.this, EvaluarO1.class));
                finish();
                break;
        }
    }
