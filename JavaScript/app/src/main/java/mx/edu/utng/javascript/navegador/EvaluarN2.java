 ...
 */
public class EvaluarN2 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluarn2_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 8, 38, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarN2.this, EvaluarN3.class));
                finish();
                break;
        }
    }
