 ...
 */
public class EvaluarL4 extends Activity  implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaliarl4_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1,3,15, resultadoCheck);
            ...
            case R.id.btn_continuar:
                ...
                if(aciertos>=4){
                    ...
                    startActivity(new Intent(EvaluarL4.this, ContenidoL.class));
                    finish();
                }
