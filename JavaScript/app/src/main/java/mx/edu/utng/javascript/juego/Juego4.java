...
public class Juego4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.juego4_layout);
        initcomponents();
    }
    ...
    private void initcomponents() {
        ...
        botonA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Palabra.equals("Douglas Crockford")) {
                    MediaPlayer mp = MediaPlayer.create(Juego4.this, R.raw.s1);
                    mp.start();
                    Toast.makeText(getApplicationContext(), "Correcto", Toast.LENGTH_SHORT).show();

                } else {
                    MediaPlayer mp = MediaPlayer.create(Juego4.this, R.raw.s2);
                    mp.start();
    ...
    public void presionBotonSiguiente(View v) {
        ...
        if (Palabra.equals("Douglas Crockford")){
            startActivity(new Intent(Juego4.this, Juego5.class));
            finish();
        }else {
            startActivity(new Intent(Juego4.this, Juego4.class));
            finish();
        }
