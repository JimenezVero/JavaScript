 ...
 */
public class EvaluarO1 extends Activity implements View.OnClickListener{
    //crear variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluaro1_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_califi:
                ...
                respuestaEvaluacion = new RespuestaEvaluacion(1, 5, 22, resultadoCheck);
            ...
            case R.id.btn_continuar:
                startActivity(new Intent(EvaluarO1.this, EvaluarO2.class));
                finish();
                break;
        }
    }
